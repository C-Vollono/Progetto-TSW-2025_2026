...
<head>
    ...
    <title>Gestione Catalogo Premium</title>

    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/css/catalogo.css">
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/css/admin_catalogo.css">
</head>
<body>
    ...
    <section class="catalog-section">
        <div class="catalog-header">
            ...
            <a href="${pageContext.request.contextPath}/Admin/GestioneProdotti?action=insertForm"
        ...
        <div class="catalog-layout">
                ...
                <form action="${pageContext.request.contextPath}/Admin/GestioneProdotti" method="GET">
                    ...
                    <div class="filter-group">
                        ...
                        <select name="categoria" id="categoria">
                            <option value="All" ${empty selCategoria || selCategoria == 'All' ? 'selected' : ''}>
                                Tutte le categorie
                            </option>
                            <c:forEach var="macro" items="${tutteLeMacro}">
                                <option value="${macro.idMacro}"
                                    ${selCategoria != 'All' && selCategoria == macro.idMacro ? 'selected' : ''}>
                                    ${macro.nomeMacro}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="filter-group"
                         id="filter-group-micro"
                         style="${selCategoria == 'All' || empty selCategoria ? 'display:none;' : ''}">
                        <label for="microcategoria">Sotto-categoria:</label>
                        <select name="microcategoria" id="microcategoria">
                            <option value="All" ${empty selMicrocategoria || selMicrocategoria == 'All' ? 'selected' : ''}>
                                Tutte le sotto-categorie
                            </option>
                            <c:if test="${not empty microDiQuestaMacro}">
                                <c:forEach var="micro" items="${microDiQuestaMacro}">
                                    <option value="${micro.idMicro}"
                                        ${selMicrocategoria != 'All' && selMicrocategoria == micro.idMicro ? 'selected' : ''}>
                                        ${micro.nomeMicro}
                                    </option>
                                </c:forEach>
                            </c:if>
                    ...
                    <div class="filter-group">
                        ...
                        <select name="marca" id="marca">
                            <option value="All" ${empty selMarca || selMarca == 'All' ? 'selected' : ''}>
                                Tutte le marche
                            </option>
                            <c:forEach var="m" items="${tutteLeMarche}">
                                <option value="${m}" ${selMarca == m ? 'selected' : ''}>
                                    ${m}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="filter-group">
                        ...
                        <select name="prezzo" id="prezzo">
                            <option value="All" ${empty selPrezzo || selPrezzo == 'All' ? 'selected' : ''}>
                                Tutti i prezzi
                            </option>
            ...
            <div class="catalog-main">
                ...
                <form action="${pageContext.request.contextPath}/Admin/GestioneProdotti"
                      method="GET"
                      class="form-topbar-flex">
                    ...
                    <div class="catalog-topbar">
                        <div class="search-wrapper">
                            <input type="text"
                                   id="catalog-search"
                                   placeholder="Cerca prodotti nel pannello admin..."
                            ...
                            <button type="submit" class="btn-lente-catalogo" aria-label="Cerca">
                                <img src="${pageContext.request.contextPath}/images/lente.svg"
                                     alt="Cerca"
                                     class="icona-lente">
                            </button>
                        ...
                        <div class="catalog-sort">
                            ...
                            <select name="ordina" id="ordina" onchange="this.form.submit()">
                                ...
                                <option value="prezzoasc" ${selOrdina == 'prezzoasc' ? 'selected' : ''}>Prezzo crescente</option>
                                <option value="prezzodesc" ${selOrdina == 'prezzodesc' ? 'selected' : ''}>Prezzo decrescente</option>
                            </select>
                        </div>
                    </div>
                </form>
                            ...
                            <c:forEach var="prodotto" items="${prodottiCatalogo}">
                                <div class="product-card">
                                    <div class="product-image">
                                        <img src="${pageContext.request.contextPath}/images/${prodotto.urlImmagine}"
                                             alt="${prodotto.modello}">
                                    </div>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-actions">
                                            <a href="${pageContext.request.contextPath}/Admin/GestioneProdotti?action=editForm&idProdotto=${prodotto.idProdotto}"
                                               class="btn-details">
                                                Modifica
                                            </a>
                                            ...
                                            <form action="${pageContext.request.contextPath}/Admin/GestioneProdotti"
                                                  method="POST"
                                                  class="form-delete-container"
                                                  data-product-name="${prodotto.marca} ${prodotto.modello}">
                                                <input type="hidden" name="action" value="delete">
                                                <input type="hidden" name="idProdotto" value="${prodotto.idProdotto}">

                                                <button type="submit" class="btn-delete-filled">
                                                    Elimina
                                                </button>
                                            </form>
                                        </div>
    ...
    <div id="delete-confirm-modal" class="delete-modal-overlay">
        <div class="delete-modal">
            ...
            <div class="modal-buttons">
                <button type="button" id="delete-confirm-btn" class="btn-secondary">
                    Conferma
                </button>
                <button type="button" id="delete-cancel-btn" class="btn-secondary">
                    Annulla
                </button>
            </div>
        </div>
